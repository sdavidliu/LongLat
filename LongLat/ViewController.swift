...
class ViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate, CBPeripheralManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let o9 = CLLocationCoordinate2D(latitude: 33.649111, longitude: -117.842356)
        let o10 = CLLocationCoordinate2D(latitude: 33.648995, longitude: -117.842352)
        ...
        let o55 = CLLocationCoordinate2D(latitude: 33.649208, longitude: -117.842360)
        ...
        let o59 = CLLocationCoordinate2D(latitude: 33.649110, longitude: -117.842430)
        let o60 = CLLocationCoordinate2D(latitude: 33.649128, longitude: -117.842479)
        ...
        let oz3Points = OutsideZone(name: "OZ3", points: [o11,o8,o60,o59,o9,o10])
        ...
        let oz22Points = OutsideZone(name: "OZ22", points: [o4,o7,o8,o60,o59,o9,o55,o54])
